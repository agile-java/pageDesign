...
--
-- Host: 127.0.0.1    Database: retailbank
-- ------------------------------------------------------
...
CREATE TABLE `account` (
  ...
  `create_date` datetime(1) NOT NULL,
...
DROP TABLE IF EXISTS `account_executive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `account_executive` WRITE;
/*!40000 ALTER TABLE `account_executive` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_executive` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `customer` (
  ...
  UNIQUE KEY `logincol_UNIQUE` (`ssn_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customer_status` (
  `customer_status_id` int NOT NULL AUTO_INCREMENT,
  `ssn_id` int NOT NULL,
  `customer_id` int NOT NULL,
  `status` varchar(45) NOT NULL,
  `message` varchar(100) NOT NULL,
...
-- Dump completed on 2020-06-13 16:01:45
